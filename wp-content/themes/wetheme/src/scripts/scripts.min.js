...
"use strict";!function(n){var c={init:function(){c.smoothScroll()},smoothScroll:function(){n('a[href*="#"]').click(function(){var t=n(this.hash);if(location.pathname.replace(/^\//,"")===this.pathname.replace(/^\//,"")&&location.hostname===this.hostname&&(t=t.length?t:n("[name="+this.hash.slice(1)+"]")).length)return n("html, body").stop().animate({scrollTop:t.offset().top-75},1e3),!1})}},a=function(){var t=n("body");50<n(document).scrollTop()?t.addClass("scroll"):t.removeClass("scroll")},r={prevent:!1,init:function(){n("#menu-button, .m-overlay").click(function(t){t.preventDefault(),r.toggle()})},toggle:function(){r.prevent||(n("body").toggleClass("m-open"),r.prevent=!r.prevent,setTimeout(function(){r.prevent=!r.prevent},400))}};n(document).ready(function(){var o,t,e,i,l;c.init(),r.init(),n(window).scroll((o=function(){a()},i=void 0,l=t||100,function(){var t=this,n=arguments;clearTimeout(i),i=setTimeout(function(){i=null,e||o.apply(t,n)},l),e&&!i&&o.apply(t,n)}))}),n(window).on("load",function(){})}(jQuery);
